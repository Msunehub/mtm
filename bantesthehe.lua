...
UIGradient.Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, Color3.fromRGB(101, 235, 68)), ColorSequenceKeypoint.new(0.32, Color3.fromRGB(71, 227, 32)), ColorSequenceKeypoint.new(0.65, Color3.fromRGB(117, 224, 90)), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(43, 242, 17))}
...
local NotiFrame = Instance.new("Frame")
	...
	function DiscordLib:Notification(text,text2,delays,logo)
		...
		txdlid.BackgroundColor3 = Color3.fromRGB(45, 230, 21)
		...
		txdlid.TextColor3 = Color3.fromRGB(45, 230, 21)
		...
		Time.Active = true
		Time.BackgroundColor3 = Color3.fromRGB(45, 230, 21)
 ...
 _G.Color = Color3.fromRGB(52, 240, 19)
 ...
 _G.TabThemeColor = Color3.fromRGB(52, 240, 19)
 ...
 Name.Text = text
 Name.TextColor3 = Color3.fromRGB(64, 235, 12)
 ...
 Hub.Text = "   Hub"
 Hub.TextColor3 = Color3.fromRGB(64, 235, 12)
 Hub.TextSize = 16.000
...
--------------------------------------------------------------------
local Library = Update:Window("Min Gaming","")
------------------------------------------
...
Setting:Button("Sao Chép Link YouTube",function()
 
 setclipboard("https://youtube.com/@mingamingne")
  DiscordLib:Notification("Thông Báo" , "Đã Sao Chép Link YouTube" , 10 ,13717478897 )
 end)
...
ca:Toggle("Auto Drive Boat", _G.DomadicAutoDriveBoat,function(value)
 ...
 game:GetService("RunService"):Set3dRenderingEnabled(true)
   ...
   Setting:Button("Giảm Lag",function()
	...
	function DiscordLib:Notification(text,text2,delays,logo)
      ...
      DiscordLib:Notification("Thông Báo" , "Bật Xong Sẽ Bị Đứng Máy 5-10 Giây" , 10 ,13717478897 )
      wait(3)
...
game:GetService("ReplicatedStorage"):WaitForChild("Remotes"):WaitForChild("CommF_"):InvokeServer(unpack(args))
DiscordLib:Notification("Thông Báo" , "Hoàn Tất" , 10 ,13717478897 )
end)
...
DiscordLib:Notification("Thông Báo" , "Nhân Phẩm Đã Lên 1000%" , 10 ,13717478897 )
  end)
...
game:GetService("ReplicatedStorage"):WaitForChild("Remotes"):WaitForChild("CommF_"):InvokeServer(unpack(args))
 ...
 Shop:Button("Mua GodHuman",function()
  ...
  Shop:Button("Buy Sanguine Art [ $5,000,000 5,000F ]",function()
...
Stats:Seperator("Nâng chỉ Sô")	

Stats:Toggle("Nâng Cận chiến",false,function(Value)
melee = Value    
end)
Stats:Toggle("Nâng Phòng thủ",false,function(value)
defense = value
end)
Stats:Toggle("nâng Kiếm",false,function(value)
sword = value
end)
Stats:Toggle("Nâng súng",false,function(value)
gun = value
end)
Stats:Toggle("Nâng fruit",function(value)
demonfruit = value
end)
